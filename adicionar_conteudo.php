            ...
            <div class="card border-primary bg-dark" style="padding: 1em;">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control text-light bg-dark" name="nome" placeholder="Ace Ventura">
                    </div>
                    <div class="mb-3">
                        <label>Data de lançamento</label><br>
                        <input type="date" class="bg-secondary text-light btn-outline-light col-12" name="lancamento">
                    </div>
                    <div class="mb-3">
                        <label class="form-label text-light">Sinopse</label>
                        <textarea class="form-control text-light bg-dark" name="sinopse" rows="3"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="formFile" class="form-label text-light">Imagem de capa (1920x880)</label>
                        <input class="form-control text-light bg-dark" type="file" accept="image/gif, image/jpeg, image/png, image/bmp" name="imagem">
                    </div>
                    <div class="mb-3">
                        <p>
                        <h5>Categoria</h5>
